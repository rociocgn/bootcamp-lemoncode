export const CATALOGO_BANCOS: Record<string, string> = {
...
export function obtenerNombreBanco(codigoBanco: string): string {
  return CATALOGO_BANCOS[codigoBanco] ?? "Banco desconocido";
}